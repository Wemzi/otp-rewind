    ...
    retVal.add(
        Container(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [ Text('${formatter.format(element.amount).replaceAll(',', ' ')} Ft (Legmagasabb ${element.percentage}%)',
                  style: const TextStyle(
                    fontSize: 16,
                    color: colorOTPgreen,
                    height: 1,
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [ Text(
                                ...
                                '${formatter.format(backend.currentUser!.avgSpend).replaceAll(',',' ')} Ft' : '500 345 Ft',
                                style: const TextStyle(
                                  fontSize: 16,
                                  color: colorOTPwhite,
                                  height: 1,
